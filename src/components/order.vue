    ...
    <div class="account-order">
      <div class="gray-box">
        ...
        <div class="js-list-inner">
          <div class="box-inner order-cart order-list-cart clear" v-for="(order,index) in  order" :key="index">
            <div class="gray-sub-title cart-title">
              ...
              <span class="order-detail">
                <router-link :to="{name:'SubmitOrder',query:{orderId:order.orderId}}">查看详情&gt;</router-link>
              </span>
            ...
            <div class="prod-operation">
              ...
              <div class="status">
                <router-link class="blue-small-btn js-payment-order" :to="{name:'SubmitOrde',query:{orderId:order.orderId}}"  v-if="!order.isPay">现在付款</router-link>
                <a v-else>已完成</a>
              </div>
            </div>
          </div>
